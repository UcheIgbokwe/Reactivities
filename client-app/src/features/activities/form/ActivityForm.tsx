...
import CategoryInput from '../../../app/common/options/categoryOptions';
                    ...
                    <FinalForm 
                        ...
                        render={({ handleSubmit, invalid, pristine }) => (
                            <Form onSubmit={handleSubmit} loading={loading}>
                                ...
                                <Field  name='category' placeholder='Category' value={activity.category} component={SelectInput} options={CategoryInput} />
                                <Form.Group widths='equal'>
                                    <Field  name='date' type='datetime-local' placeholder='Date' date={true} value={activity.date} component={DateInput} />
